...
{
    return [self lj_resizedImage:imgName xPos:0.5 yPos:0.5];
}
...
{
    return [self lj_imageOfQRFromString:string codeSize:codeSize red:0 green:0 blue:0];
}
...
{
    return [self lj_imageOfQRFromString:string codeSize:codeSize red:red green:green blue:blue insertImage:nil roundRadius:0];
}
...
{
    return [self lj_imageOfQRFromString:string codeSize:codeSize red:0 green:0 blue:0 insertImage:insertImage roundRadius:roundRadius];
}
...
{
    return [self lj_imageOfQRFromString:string codeSize:codeSize red:0 green:0 blue:0 insertImage:insertImage roundRadius:5];
}
...
{
    return [self lj_imageOfQRFromString:string codeSize:codeSize red:red green:green blue:blue insertImage:insertImage roundRadius:5];
}
...
+ (UIImage *)imageInsertedImage:(UIImage *)originImage insertImage:(UIImage *)insertImage radius:(CGFloat)radius
{
    ...
    insertImage = [insertImage lj_imageWithCornerRadius:radius];
    UIImage * whiteBG = [self lj_imageWithColor:[UIColor whiteColor] size:CGSizeMake(200, 200)];
    whiteBG = [whiteBG lj_imageWithCornerRadius:radius];
    //白色边缘宽度
